...
<ComClass(StandardSpaceEitherSide.ClassId, StandardSpaceEitherSide.InterfaceId, StandardSpaceEitherSide.EventsId), _
 ProgId("OrmapTaxlotEditing.StandardSpaceEitherSide")> _
Public NotInheritable Class StandardSpaceEitherSide
