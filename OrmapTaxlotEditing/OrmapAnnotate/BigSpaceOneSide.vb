...
<ComClass(BigSpaceOneSide.ClassId, BigSpaceOneSide.InterfaceId, BigSpaceOneSide.EventsId), _
 ProgId("OrmapTaxlotEditing.BigSpaceOneSide")> _
Public NotInheritable Class BigSpaceOneSide
