...
#End Region
<ComClass(BigSpaceEitherSide.ClassId, BigSpaceEitherSide.InterfaceId, BigSpaceEitherSide.EventsId), _
 ProgId("OrmapTaxlotEditing.BigSpaceEitherSide")> _
Public NotInheritable Class BigSpaceEitherSide
