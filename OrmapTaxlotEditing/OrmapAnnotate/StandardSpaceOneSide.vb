...
<ComClass(StandardSpaceOneSide.ClassId, StandardSpaceOneSide.InterfaceId, StandardSpaceOneSide.EventsId), _
 ProgId("OrmapTaxlotEditing.StandardSpaceOneSide")> _
Public NotInheritable Class StandardSpaceOneSide
