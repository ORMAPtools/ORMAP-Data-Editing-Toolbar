...
''' <summary>
''' Moves annotation which straddles a line up by one wide space
''' </summary>
Public NotInheritable Class AnnoBothUpWide
...
#Region "Methods"
    ...
    ''' <summary>
    ''' Calls AnnotationUtilities.MoveAnnotationElements to move the annotation elements.
    ''' </summary>
        ...
        Try
            ...
            If Not DataMonitor.HasValidMapIndexData Then
                MessageBox.Show("Missing data: Valid ORMAP MapIndex layer not found in the map." & NewLine & _
                                ...
                                "AnnoBothUpWide", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                Exit Sub
            End If
