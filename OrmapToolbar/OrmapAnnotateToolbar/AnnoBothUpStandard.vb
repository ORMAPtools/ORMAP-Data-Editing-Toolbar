...
''' <summary>
''' Moves annotation which straddles a line up by one standard space
''' </summary>
Public NotInheritable Class AnnoBothUpStandard
        ...
        Try
            ...
            If Not DataMonitor.HasValidMapIndexData Then
                MessageBox.Show("Missing data: Valid ORMAP MapIndex layer not found in the map." & NewLine & _
                                ...
                                "AnnoBothUpStandard", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                Exit Sub
            End If
