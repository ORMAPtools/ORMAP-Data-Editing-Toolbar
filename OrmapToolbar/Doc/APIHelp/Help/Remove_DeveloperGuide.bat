...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "ORMAP Tech Group" /mediaBookList "ORMAP Taxlot Editing Toolbar AddIn Developer Guide" /productName "ORMAP Taxlot Editing Toolbar AddIn"
